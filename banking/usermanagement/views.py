...
class UserRegistration(APIView): 
    # permission_classes=[IsAuthenticated,Registration] 

#     # SetPagination=UserSerializer 
    ...
    def patch(self,request):
     ...
     try:
        ...
        if user.usertype=="customer":
             ...
             return Response({"status":"access denaid"}, status=status.HTTP_400_BAD_REQUEST)

     except User.DoesNotExist:
            return Response({"status": "user doestnot exist"}, status=status.HTTP_400_BAD_REQUEST) 
